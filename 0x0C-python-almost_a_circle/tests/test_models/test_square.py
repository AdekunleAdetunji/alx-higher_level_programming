...
class TestRectangle(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        """
        cls.new_class = Square
        cls.obj_1 = Square(1, 2)
        cls.obj_2 = Square(1, 2, 1, 1)
    ...
    def test_1_inst_arg(self):
        ...
        """
        self.assertRaises(TypeError, type(self).new_class)
    ...
    def test_wrong_w_inst(self):
        ...
        """
        self.assertRaises(TypeError, Square, "a", 1)

    def test_wrong_h_inst(self):
        """
        check for wrong height instantiation
        """
        self.assertRaises(TypeError, Square, 1, "a")
    ...
    def test_wrong_x_inst(self):
        ...
        """
        self.assertRaises(TypeError, Square, 1, 1, "a")
    ...
    def test_diff_id_type(self):
        ...
        """
        self.assertTrue(Square(1, 1, id="2"))
        self.assertEqual(Square(1, 1, id="3").id, "3")
    ...
    def test_update_args_3(self):
        ...
        self.assertEqual(getattr(type(self).obj_1, "height"), 1)
    ...
    def test_update_args_4(self):
        ...
        self.assertEqual(getattr(type(self).obj_1, "x"), 3)
    ...
    def test_update_args_5(self):
        ...
        """
        type(self).obj_1.update(1, 2, 3, 4)
        self.assertEqual(getattr(type(self).obj_1, "y"), 4)
